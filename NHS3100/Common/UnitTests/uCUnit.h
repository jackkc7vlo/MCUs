...
#define UCUNIT_WritePassedMsg(msg, args)                     \
    ...
    {                                                        \
        ...
        UCUNIT_WriteString("):");                            \
        UCUNIT_WriteInt(uc_elapsed_time_value());            \
        UCUNIT_WriteString(" us\n");                         \
        UCUNIT_WriteString(WHITE);                           \
    } while (0)
#else
#define UCUNIT_WritePassedMsg(msg, args)
...
#define UCUNIT_TestcaseEnd()                                              \
    ...
    {                                                                     \
        ...
        {                                                                 \
            UCUNIT_WriteFailedMsg("End Test\n", "");                      \
...
#define UCUNIT_ElapsedTime() uc_elapsed_time_value()
/*****************************************************************************/
