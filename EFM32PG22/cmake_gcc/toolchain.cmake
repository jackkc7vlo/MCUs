...
elseif(APPLE)
  ...
  set(TOOLCHAIN_DIR "/home/jack/.silabs/slt/installs/conan/p/gcc-a442105b5c2637/p//bin/")
endif()
...
elseif(APPLE)
  ...
  set(POST_BUILD_EXE "/home/jack/.silabs/slt/installs/archive/commander/commander")
endif()
...
elseif(APPLE)
  ...
  set(NINJA_RUNTIME_PATH "/home/jack/.silabs/slt/installs/conan/p/ninja1b9fed093d653/p/ninja")
endif()
