...
static reg_gpio_t * p_gpio_a = (reg_gpio_t * const) GPIO_PORTA_APB_BASE_ADDR;
static reg_gpio_t * p_gpio_b = (reg_gpio_t * const) GPIO_PORTB_APB_BASE_ADDR;
static reg_gpio_t * p_gpio_c = (reg_gpio_t * const) GPIO_PORTC_APB_BASE_ADDR;
static reg_gpio_t * p_gpio_d = (reg_gpio_t * const) GPIO_PORTD_APB_BASE_ADDR;
static reg_gpio_t * p_gpio_e = (reg_gpio_t * const) GPIO_PORTE_APB_BASE_ADDR;
static reg_gpio_t * p_gpio_f = (reg_gpio_t * const) GPIO_PORTF_APB_BASE_ADDR;
static reg_gpio_t * p_gpio_a_ahb = (reg_gpio_t * const) GPIO_PORTA_AHB_BASE_ADDR;
static reg_gpio_t * p_gpio_b_ahb = (reg_gpio_t * const) GPIO_PORTB_AHB_BASE_ADDR;
static reg_gpio_t * p_gpio_c_ahb = (reg_gpio_t * const) GPIO_PORTC_AHB_BASE_ADDR;
static reg_gpio_t * p_gpio_d_ahb = (reg_gpio_t * const) GPIO_PORTD_AHB_BASE_ADDR;
static reg_gpio_t * p_gpio_e_ahb = (reg_gpio_t * const) GPIO_PORTE_AHB_BASE_ADDR;
static reg_gpio_t * p_gpio_f_ahb = (reg_gpio_t * const) GPIO_PORTF_AHB_BASE_ADDR;
